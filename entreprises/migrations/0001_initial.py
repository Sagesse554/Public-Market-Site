    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Rfc_categories', models.ManyToManyField(null=True, through='entreprises.Prestation3', to='entreprises.categorie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mnf_logo', models.ImageField(blank=True, null=True, upload_to='Images/Logos/')),
                ...
                ('Mnf_prestations', models.ManyToManyField(null=True, through='entreprises.Allocation2', to='entreprises.materiel')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mnf_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entreprises.manifestation')),
                ('Prs_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entreprises.personnel')),
                ('Ptn2_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entreprises.prestation2')),
            ],
        ),
